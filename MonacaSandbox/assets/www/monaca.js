...
(function(PhoneGap) {
    ...
    monaca.updateStyle = function(id, name, value) {
        if (typeof id == "string") {
    ...
    if (isAndroid) {
        ...
        monaca.updateStyle = function(id, name, value, success, failure) {
            var style = {};
            style[name] = value;
    ...
    monaca.popPage = function(path, options) {
        options = options || {};
    ...
    */
    ...
    monaca.load = function(path) {
        PhoneGap.exec(null, null, transitionPluginName, "link", [path, options]);
    };
