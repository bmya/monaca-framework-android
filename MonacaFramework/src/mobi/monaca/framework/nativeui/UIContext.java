...
public class UIContext extends ContextWrapper {
    ...
    protected Map<Integer, Integer> computedFontSizeCache = new HashMap<Integer, Integer>();
    ...
    public void changeLocationWithoutUIFile(String path) {
    	MyLog.v(TAG, "changeLocationWithoutUIFile. path:" + path);
        pageActivity.loadRelativePathWithoutUIFile(path);
    }
